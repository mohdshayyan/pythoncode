...
# Creating the empdata table if it doesn't exist
cursorObject.execute("CREATE TABLE IF NOT EXISTS empdata (Id INT PRIMARY KEY, Name VARCHAR(255), Email_Id VARCHAR(255), Phone_no VARCHAR(20), Address VARCHAR(255), Post VARCHAR(255), Salary FLOAT)")
...
def Add_Employ():
    ...
    if re.match(phone_pattern, Phone_no):
